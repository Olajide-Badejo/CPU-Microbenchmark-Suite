...
% Title page: title centered horizontally and vertically, author and date at
% the center bottom.
\begin{titlepage}
\centering
\vspace*{\fill}
{\Huge\bfseries CPU Microbenchmark Suite\par}
\vspace{0.8em}
{\Large\itshape Measuring What Spec Sheets Only Claim\par}
\vspace{0.4em}
{\large Cache Latency, STREAM Bandwidth, and Peak SIMD FLOPS\\
on an Intel Core i7-14700K\par}
\vspace*{\fill}
...
% Contents on its own page, and the first chapter on the page after.
\clearpage
\tableofcontents
\clearpage
