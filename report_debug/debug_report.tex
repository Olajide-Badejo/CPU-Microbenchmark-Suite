...
\vspace{0.8em}
{\Large\itshape Engineering Debug Report\par}
\vspace*{\fill}
...
\clearpage
\begin{abstract}
This report records the debugging that the clean results do not show. On this
platform the anti optimization fight took the form of a clock measurement fight
rather than a deleted loop. Each finding states the symptom, the root cause, the
fix and why it was chosen, and how it was verified. It is an equal rank
deliverable.
\end{abstract}

% Contents on its own page, and the first section on the page after.
\clearpage
\tableofcontents
\newpage
